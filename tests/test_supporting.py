...
'''
class SupportingTest(unittest.TestCase):
    "test of functions from supporting module"
    ...
    def test_units_parser(self):
        ...
        for t, r in zip(testlist, reslist):
            self.assertEqual(r, from_string(t))
    
    def test_brian_unit_to_lems(self):
        self.assertEqual(brian_unit_to_lems(20.*mV), "20.*mV")
        self.assertEqual(brian_unit_to_lems(0*ms), "0")

    def test_neuromlsimulation(self):
        ...
        self.assertEqual(strrepr, simulation_tag_output)
    ...
    def test_simplenetwork(self):
        ...
        self.assertEqual(strrepr, simplenetwork_tag_output)
